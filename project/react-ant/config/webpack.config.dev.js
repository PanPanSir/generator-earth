...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      'ROOT_SOURCE': path.join(__dirname, '..', 'src'),
    },
  ...
  module: {
    ...
    rules: [
      ...
      /* jiajianrong 2017-7-7 webpack2 loader code-style changed */
      // {   test: /\.scss$/,   use: [     {       loader: "style-loader"     }, {
      // loader: "css-loader"     }, {       loader: "sass-loader"     }   ] } ** STOP
      // ** Are you adding a new loader? Remember to add the new extension(s) to the
      // "file" loader exclusion list.
    ]
  },
  plugins: [
