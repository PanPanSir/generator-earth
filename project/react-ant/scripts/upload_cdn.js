...
let fs = require('fs');
let {PATH_FROM, PATH_TO, FTP_IP, FTP_USERNAME, FTP_PASSWORD} = require('./upload_cdn_conf.js');
...
/**
 * npm run build后会把所有代码release到/build目录
 * node upload2ftp.js会把/build目录下所有文件上传至FTP_IP和FTP_USERNAME对应的PATH_TO目录下
 * 本项目中为ftp服务器的/funder根目录
 */
